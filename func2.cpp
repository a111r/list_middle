...
void itc_odd_even_analysis_lst(const vector <int> &lst){
    ...
    vector <int> a;
    vector <int> b;
    itc_odd_even_separator_lst(lst, a, b);
    cout << "Анализ списка:" << endl;
    cout << "Количество четных чисел: " << ev.size() << "," << '\t'	<< '\t' << "Количество нечетных чисел: " << unev.size() << endl;
    cout << "Максимальная четная цифра: " << itc_max_lst(a) << "," << '\t'	<< '\t' << "Максимальная нечетная цифр: " << itc_max_lst(b) <<"," << endl;
    cout << "Минимальная четная цифра: "<< itc_min_lst(a) << "," << '\t' << '\t' << "Минимальная нечетная цифра: "<< itc_min_lst(b) << "," << endl;
    cout << "Сумма четных чисел: "<< itc_sumlst(a) << "," << '\t'	<< '\t' << "Сумма нечетных чисел: "<< itc_sumlst(b) << "," << endl;
}
